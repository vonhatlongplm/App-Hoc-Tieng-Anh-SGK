  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-6 bg-slate-50">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden text-center p-8">
        ...
        <p className="text-slate-600 mb-8">Đăng nhập để lưu trữ tiến trình học tập của bạn trên đám mây, học mọi lúc mọi nơi.</p>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 text-slate-800 rounded-xl px-6 py-3.5 font-semibold text-lg hover:bg-slate-50 hover:border-slate-300 transition outline-none disabled:opacity-50"
        >
